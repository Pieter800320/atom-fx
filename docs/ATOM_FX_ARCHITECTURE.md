...
{ "message": {
    ...
    "data": { "type":"gold_signal|level_alert|structure_event|regime_flip|archetype_change|volatility_spike|tf_alignment|conviction_extreme|bb_touch|recommendation",
