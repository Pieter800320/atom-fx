...
def risk_on():
    ...
    mr={"primary":{"code":"A","name":"Growth-positive risk-on","confidence":"High","distinct_axes":3},
        ...
        "evidence":[{"axis":"risk","read":"SPX↑ VIX↓ Copper↑","supports":True,"confirms_today":"confirming"},
                    {"axis":"rates","read":"US10Y↑ modest","supports":True,"confirms_today":"confirming"},
                    {"axis":"usd","read":"DXY flat","supports":False,"confirms_today":"quiet"},
                    {"axis":"commodity","read":"Copper↑ WTI firm","supports":True,"confirms_today":"confirming"}],
...
def risk_off():
    ...
    mr={"primary":{"code":"D","name":"Recession shock","confidence":"High","distinct_axes":3},
        ...
        "evidence":[{"axis":"risk","read":"SPX↓ VIX↑ Copper↓","supports":True,"confirms_today":"confirming"},
                    {"axis":"rates","read":"yields↓","supports":True,"confirms_today":"confirming"},
                    {"axis":"safe_haven","read":"Gold↑ JPY↑ CHF↑","supports":True,"confirms_today":"diverging"}],
        "conflicts":[],
...
def ranging():
    ...
    mr={"primary":{"code":None,"name":"No dominant regime","confidence":"Low","distinct_axes":0},
        ...
        "evidence":[{"axis":"risk","read":"SPX flat VIX flat","supports":False,"confirms_today":"quiet"},
                    {"axis":"rates","read":"yields flat","supports":False,"confirms_today":"quiet"}],
...
def liquidity_shock():
    ...
    mr={"primary":{"code":"E","name":"Liquidity shock","confidence":"Low","distinct_axes":2},
        ...
        "evidence":[{"axis":"risk","read":"VIX spikes, SPX↓ hard","supports":True,"confirms_today":"confirming"},
                    {"axis":"safe_haven","read":"USD JPY CHF bid","supports":True,"confirms_today":"confirming"}],
