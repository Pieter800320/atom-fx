...
val TECHNICAL_REGIME_PLAYBOOK: Map<String, TechnicalRegimeEntry> = listOf(
    TechnicalRegimeEntry(
        regime = "Risk-On",
        coreStory = "Two or more of three price-based checks agree that risk appetite is genuinely broad-based right now: safe-havens (JPY/CHF) are being sold relative to commodity/risk currencies (AUD/NZD/CAD) on CSM, the dollar is being sold relative to the other majors on CSM, or a clear majority of six risk pairs (AUDUSD, NZDUSD, GBPUSD, EURUSD, AUDJPY, NZDJPY) have bullish pills at D1. This is a purely technical read — it doesn't know or care WHY risk appetite is up, only that price itself is confirming it from more than one angle at once.",
        votesExplanation = "Vote 1 (safe-haven CSM): JPY+CHF average vs AUD+NZD+CAD average — needs a 15-point CSM gap the risk side's way to count as risk-on. Vote 2 (USD CSM): USD vs EUR/GBP/AUD/NZD average — needs a 20-point gap the non-USD side's way. Vote 3 (risk-basket pills): needs at least 2 more bullish than bearish pills across the six risk pairs at D1. Two of these three agreeing is enough to call the regime; the third can be dissenting or flat.",
    ...
    TechnicalRegimeEntry(
        regime = "Risk-Off",
        coreStory = "The mirror image of Risk-On: two or more of the same three checks now agree the other way — safe-havens are being bought relative to commodity currencies, USD is being bought relative to the other majors, or a clear majority of the six risk pairs have bearish pills at D1. Same caveat as Risk-On: this is price/CSM only, it doesn't distinguish a genuine growth scare from a liquidity event from a simple rate-driven USD bid — for that distinction, this is exactly what the Macro Archetype's Regime D/E split exists for.",
        votesExplanation = "Same three votes as Risk-On, run the other direction: safe-haven CSM 15+ points above the risk-currency average, USD CSM 20+ points above the non-USD average, or 2+ more bearish than bullish pills across the six risk pairs at D1.",
