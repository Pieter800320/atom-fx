...
val LIBRARY_ENTRIES: List<LibraryEntry> = listOf(
    ...
    LibraryEntry(
        ...
        whyItMatters = "ADX answers a different question than direction — CSM, pills, and Potential already cover that. It answers whether there's an actual trend worth trading, or just noise with a directional lean. Two pairs can share the same CSM-implied bias and read completely differently on ADX; that gap is exactly what the wheel's own ADX wing surfaces.",
    ),
    LibraryEntry(
        id = "five-state-score",
